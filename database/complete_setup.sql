-- CSE 340 Database Setup Script for cse340_db4
-- Run this entire script to set up your database
...
VALUES (
        'GM',
        'Hummer',
        'A rugged vehicle with a huge interior.',
    ...
    (
        ...
        '/images/vehicles/mx5.jpg',
        '/images/vehicles/mx5-tn.jpg',
        31000,
        2023,
        6000,
        'White',
...
SELECT 'Classifications:' as info;
SELECT *
FROM classification;
SELECT 'Inventory count by classification:' as info;
